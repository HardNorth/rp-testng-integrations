...
package com.epam.reportportal.example.testng.step;
...
public class NestedStepsWithDataProvider {
	...
	public static Object[][] getData() {
		return new Object[][] { new Object[] { 1, "one" }, new Object[] { 2, "two" }, new Object[] { 3, "three" },
				new Object[] { 4, "four" }, new Object[] { 5, "five" }, new Object[] { 6, "six" },
				new Object[] { 7, "seven" }, new Object[] { 8, "eight" } };
	}
	...
	public NestedStepsWithDataProvider(@ParameterKey("input") int num,
			@ParameterKey("expected_result") String numWord) {
		number = num;
